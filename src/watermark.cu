//
// OS-specific code and NVIDIA device informational logic is based on cuda-sample code:
//  https://github.com/NVIDIA/cuda-samples/blob/master/Samples/4_CUDA_Libraries/boxFilterNPP/boxFilterNPP.cpp
//
